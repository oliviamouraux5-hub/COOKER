                ...
                <div className="lg:col-span-8 space-y-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <Link 
                        href="/recipes/new"
                        className="flex items-center gap-2 bg-secondary/10 hover:bg-secondary/20 text-secondary text-xs font-black uppercase tracking-wider px-5 py-3.5 rounded-2xl transition-all duration-300 shadow-sm hover:scale-[1.02] border border-secondary/10 active:scale-95 cursor-pointer"
                      >
                      ...
                      {recipes.length > 0 ? (
                        <Badge variant="outline" className="border-primary text-primary px-4 py-2.5 rounded-2xl font-bold">Generated by AI</Badge>
                      ) : (
                        <Badge variant="outline" className="border-secondary text-secondary px-4 py-2.5 rounded-2xl font-bold">Chef's Featured</Badge>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-8">
                    {isGenerating ? (
                      ...
                      <div className="col-span-full py-16 flex flex-col items-center justify-center text-center space-y-4 bg-white rounded-[2.5rem] border border-dashed border-primary/20 shadow-premium p-8">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                            We couldn't find a matching library recipe for those specific ingredients. Click below to generate one with AI or upload your own!
                          </p>
                        </div>
                        <div className="flex gap-3 pt-2">
                          <Button
                            type="button"
                            onClick={() => setShowCreativeModal(true)}
                            className="bg-primary hover:bg-primary/95 text-white font-black text-xs px-6 py-3.5 rounded-2xl shadow-lg shadow-primary/10 transition-all flex items-center gap-1.5 cursor-pointer"
                          >
                          ...
                          <Link
                            href="/recipes/new"
                            className="bg-white hover:bg-muted text-foreground border border-muted-foreground/10 font-black text-xs px-6 py-3.5 rounded-2xl shadow-sm transition-all flex items-center gap-1.5 cursor-pointer"
                          >
                            <Plus className="w-4 h-4" />
                            Upload Custom
                          </Link>
